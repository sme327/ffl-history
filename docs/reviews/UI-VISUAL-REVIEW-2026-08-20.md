...
**Update 2026-08-21:** graphics delivered A1/A3/A4/A7 — all QA'd and implemented same day. Tables and timeline ledgers are on the parchment material with full ink re-scoping; all ten re-lit rooms are live (Home now uses `entrance-hall.webp` at the standard scale); the spotlight cone hangs over the reigning champion; wall tile v2 is in. Remaining asset work: A2 (slim artifact frame), A5 (nameplate/monogram), A6 (small medallion variants), A8 (owner photos). Phase 4's grid audit was folded into the 2026-08-20 route audit.
